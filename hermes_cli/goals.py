...
JUDGE_SYSTEM_PROMPT = (
    ...
    "previous turn, and — when present — a list of background "
...
def judge_goal(
    ...
    *,
    ...
    # Build previous verdict context for stall detection.
...
class GoalManager:
    ...
    def next_continuation_prompt(self, judge_reason: str = "") -> Optional[str]:
        ...
        if self._state.subgoals:
            # Build judge context for stall detection in continuation prompt.
